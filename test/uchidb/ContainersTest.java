...
/**
 * @author aelmore Do not commit changes to this class
 *
 */
public class ContainersTest {
	...
	public void setUp() throws Exception {
		...
		for (int i = 0; i < intArray.length; i++) {
			// **NOTE** Autoboxing allows us to set values easy and use
			// primitive types (int, char, float, etc) as a class
	...
	public void testSetCreation() {
		...
		assertTrue("Contains 4", s1.contains(intArray[2])); // Notice the
															// autoboxing
	}
	...
	public void testListCreation() {
		...
		assertTrue("Contains 4", l1.contains(intArray[2])); // Notice the
															// autoboxing
		for (int i = 0; i < intArray.length; i++) {
